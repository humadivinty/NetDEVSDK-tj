...
int DrawEnd1String(void* srcImgData, size_t srcLength, void* destImgData, size_t& destLength, const char* overlayString, int posX, int posY)
{
    ...
    overlayInfo1.st_backgroundColor.iColorR = 58;
    overlayInfo1.st_backgroundColor.iColorG = 58;
    overlayInfo1.st_backgroundColor.iColorB = 58;
...
extern bool g_bLogEnable = false;
extern int g_iBackupCount = 1;
...
void g_WriteLog(const char* chLog)
{
    ...
    {
        sprintf_s(chLogRoot, sizeof(chLogRoot), "%s\\SW_Log_Video\\", szFileName);
