...
int BaseCamera::safeCloseThread(HANDLE& threadHandle)
{
...
bool BaseCamera::SaveImgToDisk(char* chImgPath,
    BYTE* pImgData, 
    DWORD dwImgSize, 
    int iWidth, 
    int iHeight, 
...
bool BaseCamera::SynTime(int Year, int Month, int Day, 
...
void BaseCamera::DiConnectCamera()
{
    InterruptionConnection();
    if (NULL != m_hHvHandle)
    {
